(function(w, d, PKAE) {
                        ...
                        action: function() {
                            new PKSimpleModal({
                                ...
                                body: '<div class="pk_row"><label for="k0">文件名</label>' +
                                    '<input style="min-width:250px" placeholder="mp3 filename" value="onlinedo-output.mp3" ' +
                                    ...
                                    '<div class="pk_row" id="frmtex-mp3">' +
                                    // '<input type="radio" class="pk_check" id="k1_1" name="rdslnc" value="48">' +
                                    // '<label  for="k1_1">48kbps</label>' +
                                    // '<input type="radio" class="pk_check" id="k1_2" name="rdslnc" value="64">' +
                                    // '<label  for="k1_2">64kbps</label>' +
                                    // '<input type="radio" class="pk_check" id="k1_3" name="rdslnc" value="96">' +
                                    // '<label  for="k1_3">96kbps</label><br>' +
                                    '<input type="radio" class="pk_check" id="k1" name="rdslnc" checked value="128">' +
                                    ...
                                    '<label for="k3">256kbps</label>' +
                                    '<input type="radio" class="pk_check"  id="k3_1" name="rdslnc" value="320">' +
                                    '<label for="k3_1">320kbps</label></div>' +
                                    ...
                                    '<label class="pk_lblmp3" for="k5">仅导出选中的部分</label></div>',
...

                    {
                        ...
                        action: function(e) {
                                new PKSimpleModal({
                                    ...
                                    body: '<label for="k00">输入音频网址</label>' +
                                        '<input style="min-width:250px" placeholder="请输入网址" class="pk_txt" type="text" id="k00" />',
                                    setup: function(q) {
                        ...
                        action: function(e) {
                            ...
                            new PKSimpleModal({
                                ...
                                body: '<p>请选择来源...</p>' +
                                    ...
                                    '<div class="pk_row"><label for="slk0">缓存文件</label>' +
                        ...
                        setup: function(obj) {
                            app.listenFor('DidStateChange', function(undo_states, redo_states) {
                                if (redo_states.length === 0) {
                                    obj.innerHTML = '恢复 <span class="pk_shrtct">Shft+Y</span>';
                                    obj.classList.add('pk_inact');
                                } else {
                                    obj.innerHTML = '恢复&nbsp;<i style="pointer-events:none">' + redo_states[0].desc + '</i><span class="pk_shrtct">Shft+Y</span>';
                                    obj.classList.remove('pk_inact');
                                }
                            });
                        }
    ...
    function _makeUIMainView(UI, app) {
        ...
        ttmp.innerHTML = '拖拽一个音频文件到这个窗口，或者' +
            ...
            'onclick="PKAudioEditor.engine.LoadSample()">点我使用示例音频</a>';
        main_audio_view.appendChild(ttmp);

        var ttmp2 = d.createElement('div');
        ttmp2.className = 'pk_tmpMsg2';
        ttmp2.innerHTML = '<span>请稍后...</span><div class="pk_mload"><div></div></div>' +
            '<div class="pk_prc"><span>0%</span>' +
            '<button tabIndex="-1" class="pk_btn" ' +
            'onclick="PKAudioEditor.fireEvent(\'RequestCancelModal\');">关闭</button></div>';
    ...
    function _makeUIToolbar(UI) {
        ...
        btn_loop.innerHTML = '<span>切换循环 (L)</span>';
        ...
        btn_back_jump.innerHTML = '<span>移动 (left arrow)</span>';
        ...
        btn_front_jump.innerHTML = '<span>移动 (right arrow)</span>';
        ...
        btn_back_total.innerHTML = '<span>移至开头 (Shift + left arrow)</span>';
        ...
        btn_front_total.innerHTML = '<span>移至结尾 (Shift + right arrow)</span>';
        ...
        setTimeout(function() {
            ...
            main_context.addOption('选择可见区域', function(e, x, i) {
            ...
            main_context.addOption('裁剪', function(e) {
                var region = PKAudioEditor.engine.wavesurfer.regions.list[0];
                if (!region) return;
        ...
        copy_btn.innerHTML = '<span>复制选中 (Shift + C)</span>';
        ...
        paste_btn.innerHTML = '<span>粘贴选中 (Shift + V)</span>';
        ...
        cut_btn.innerHTML = '<span>裁剪选中 (Shift + X)</span>';
        ...
        silence_btn.innerHTML = '<span>插入选中 (Shift + N)</span>';
        ...
        btn_clear_selection.innerHTML = '<span>重选 (Q key)</span>';
